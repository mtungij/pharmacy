...
<div class="header">
  ...
  <div class="col-md-6">
    <div class="pull-right">
      <a href="<?php echo base_url("seller/today_saled_report"); ?>" target="_blank" class="btn btn-info" ><i class="icon-printer" ></i>Print</a>
    </div>
  </div>
  </div>
</div>
...
<table class="table table-hover js-basic-example dataTable table-custom">
          ...
          <?php echo number_format($datas->new_sell_price); ?>/=
            ...
            <!-- <td> -->
          <!-- <a href="<?php echo base_url("seller/delete_mistake_sell/{$datas->sell_id}") ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure?')"><i class="icon-close"></i></a> -->
