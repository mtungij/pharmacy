...
<table class="table table-hover j-basic-example dataTable table-custom">
            ...
            <td><a href="<?php echo base_url("seller/edit_cashflow/{$todays_date->id}") ?>" class="btn btn-primary btn-sm"><i class="icon-pencil" title="Edit"></i></a></td>
              </tr>
        <?php endforeach; ?>
        <tr>
          <th></th>
...
<div class="body">
<?php echo form_open_multipart("seller/create_useToday"); ?>
<div class="row clearfix">
       <div class="col-sm-12">
