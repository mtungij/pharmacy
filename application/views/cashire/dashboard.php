...
<div class="header">
    <div  class="row">
        <div class="col-md-6">
            <?php $date = date("Y-m-d"); ?>
<h2>Today Order Request List - <?php echo $date; ?></h2>
</div>
...
<div class="modal fade" id="addcontact2<?php echo $cashires->order_id; ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <br>
                Seller: <?php echo $cashires->full_name; ?> <br>
                Sells status : <?php echo $cashires->sell_status;  ?>sale
            </h6>
    ...
    <table class="table table-hover j-basic-example dataTable table-custom">
            ...
            <div class="modal-footer">
                <a href="<?php echo base_url("cashire/confirm_order/{$cashires->order_id}") ?>" class="btn btn-primary btn-sm">Confirm</a>
