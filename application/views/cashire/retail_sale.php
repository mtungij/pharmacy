...
<div class="header">
  <div class="row">
    <div class="col-md-6">
  <h2>Retail Sales Today</b> </h2>
  </div>
  <div class="col-md-6">
    <div class="pull-right">
      <a href="<?php echo base_url("cashire/today_retail_salesReport"); ?>" target="_blank" class="btn btn-info" ><i class="icon-printer" ></i>Print</a>
    </div>
  </div>
  </div>
</div>
...
<table class="table table-hover js-basic-example dataTable table-custom">
        ...
        <?php endforeach; ?>
             ...
             <th>
              <h5><?php echo number_format($total_retail->Totalretail); ?>/=</h5>
              </th>
             <th></th>
             <th></th>
           </tr>
