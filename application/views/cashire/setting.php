...
<h2>Parsonal Information</h2>
   ...
   <div class="col-md-4">
<a href="<?php echo base_url("cashire/profile_pc"); ?>" class="btn btn-info btn-sm"><i class=""></i>Profile picture</a>
</div>
   <div class="col-md-4">
    <div class="pull-right">
   <a href="<?php echo base_url("cashire/change_password"); ?>" class="btn btn-info btn-sm"><i class="icon-key">Change password</i></a>
   </div>
</div>
</div>
</div>
<div class="body">
<?php echo form_open_multipart("cashire/modify_mydata/{$my->user_id}"); ?>
<div class="row clearfix">
       <div class="col-sm-6">
...
<div class="row clearfix">                            
    <div class="col-sm-12">
     ...
     <a href="<?php echo base_url("cashire/index"); ?>" class="btn btn-info"><i class="icon-arrow-left"></i></a>
      </div>
    </div>
</div>
<?php form_close(); ?>
