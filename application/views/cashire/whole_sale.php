...
<div class="header">
  <div class="row">
    <div class="col-md-6">
  <h2>Whore Sales Today</b> </h2>
  </div>
  <div class="col-md-6">
    <div class="pull-right">
      <a href="<?php echo base_url("cashire/today_whole_salesReport"); ?>" target="_blank" class="btn btn-info" ><i class="icon-printer" ></i>Print</a>
    </div>
  </div>
  </div>
</div>
...
<table class="table table-hover js-basic-example dataTable table-custom">
            ...
            <tbody>
                ...
                <?php foreach ($whole_sale as $datas): ?>
            <tr>
        ...
        <?php endforeach; ?>
             ...
             <th>
              <h5><?php echo number_format($total_wholesale->Totalwhole); ?>/=</h5>
              </th>
             <th></th>
             <th></th>
           </tr>
