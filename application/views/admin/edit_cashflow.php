...
<div class="body">
        ...
        <?php echo form_open_multipart("admin/modify_cashflow/{$cash->id}"); ?>
<div class="row clearfix">
       <div class="col-sm-3">
...
<div class="row clearfix">                            
    <div class="col-sm-12">
     ...
     <a href="<?php echo base_url("admin/get_all_cashFlow"); ?>" class="btn btn-info"><i class="icon-arrow-left"></i></a>
      </div>
    </div>
</div>
</div>
