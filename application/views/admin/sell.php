     ...
     <!-- <select type="number" class="form-control" id='cartp' onchange="updateCartItem(this, '<?php echo $cart_id; ?>','<?php echo $item_id; ?>')" style="width: 80px">
       ...
       <input type="hidden" name="quantity[]" value="<?php echo $item["qty"]; ?>">
           ...
           <!--  <td><?php //echo $item['subtotal'] - $item['buy_price'] * $item['qty']; ?></td> -->
            <td><a href="<?php echo base_url('admin_cart/removeItem/'.$item["rowid"]); ?>" class="btn btn-danger btn-sm"><i class=" icon-close"></i></a><?php //echo $products->p_name; ?></td>
              </tr>
    <?php endforeach; ?>
              <tr>
                <th>Total</th>
              ...
              <tr>
            <input type="text" name="customer" autocomplete="off" placeholder="customer name" class="form-control">
              </tr>
              <th></th>
              <th></th>
