...
<table>
  <tr>
    ...
    <th style="font-size:12px;">Totl Price</th>
    <th style="font-size:12px;">Profit</th>
    <th style="font-size:12px;">Status</th>
    <th style="font-size:12px;">Time</th>
  </tr>
    <?php $no =1; ?>
  <?php foreach ($retail_data as $all_sallesdata): ?>
 ...
 <tr>
   ...
   <th style="border: none;font-size:12px;"><?php echo number_format($total_profit_retail->Totalprofitretail);  ?>/=</th>
   <th style="border: none"></th>
   <th style="border: none"></th>
   <th style="border: none"></th>
 </tr>
