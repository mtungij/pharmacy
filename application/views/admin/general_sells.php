...
<div class="header">
    <div  class="row">
        <div class="col-md-3">
<h2>Salles / <?php echo $user_data->full_name; ?></b><br>
 From: <?php echo $from; ?> -To: <?php echo $to; ?> </h2>
</div>
<div class="col-md-3">
  
      Total sell today <input type="" readonly placeholder="Tsh.<?php echo number_format($total_sell->total_mauzo); ?>" name="" class="form-control">
