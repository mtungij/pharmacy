...
<h2>Parsonal Information</h2>
   ...
   <div class="col-md-4">
<a href="<?php echo base_url("admin/profile_pc"); ?>" class="btn btn-info btn-sm"><i class=""></i>Profile picture</a>
<a href="<?php echo base_url("admin/shop_info") ?>" class="btn btn-secondary btn-sm"><i class=""></i>Shop Information</a>
</div>
   <div class="col-md-4">
    <div class="pull-right">
   <a href="<?php echo base_url("admin/change_password"); ?>" class="btn btn-info btn-sm"><i class="icon-key">Change password</i></a>
   </div>
</div>
</div>
</div>
<div class="body">
<?php echo form_open_multipart("admin/modify_mydata/{$my->user_id}"); ?>
<div class="row clearfix">
       <div class="col-sm-6">
